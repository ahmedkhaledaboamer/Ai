            ...
            {isOpen && (
              ...
              >
                <motion.div
                  ...
                  dir={isRTL ? "rtl" : "ltr"}
                  className={cn(
                    "absolute top-0 bottom-0 w-80 max-w-[85vw] bg-secondary/95 backdrop-blur-sm shadow-lg shadow-black/20 flex flex-col",
                    panelSide
                  )}
                      ...
                      {routes.map((route, index) => (
                        ...
                        >
                          <Link
                            ...
                            onClick={closeMenu}
                            className={cn(
                              "navbar-link block text-lg py-3 px-2 -mx-2 rounded-lg transition-colors duration-300",
